...
/*
Memory map:
+ 0 - ID register, always 0x50534958 (PSIX)
+ 4 - R0
+ 8 - R1
+12 - R2
+16 - R3
...
Functions:
 0 - Identify available functions
 1 - Exit
    Inputs: 
        R0 - exit code
    Outputs:
 ...
 2 - Debug out
    Inputs:
        R0 - address in guest memory to string
        R1 - string length
    Outputs:
        None
 3 - Open file
    Inputs:
        R0 - address in guest memory to file name string
        R1 - file name length
        R2 - open mode
    Outputs:
        R0 - error code
 ...
 4 - Write file
    Inputs:
        R0 - file descriptor
        R1 - buffer address in guest memory
        R2 - length of buffer
    Outputs
        R0 - error code
